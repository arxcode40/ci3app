			...
			<div class="card-body">
				<div class="gx-3 mb-3 row">
					...
					<div class="col-md-8 col-lg-9">
						<input autofocus="autofocus" class="form-control <?= form_error('name') === '' ? '' : 'is-invalid' ?>" id="name" name="name" placeholder="Masukkan nama produk" type="text" value="<?= html_escape(set_value('name', $product['name'])) ?>" />
				...
				<div class="gx-3 mb-3 row">
					...
					<div class="col-md-8 col-lg-9">
						<div class="has-validation input-group">
							<input class="form-control <?= form_error('quantity') === '' ? '' : 'is-invalid' ?>" id="quantity" inputmode="numeric" name="quantity" oninput="numberFormat();" placeholder="Masukkan jumlah produk" type="text" value="<?= html_escape(set_value('quantity', number_format($product['quantity'], 0, ',', '.'))) ?>" />
				...
				<div class="gx-3 row">
					...
					<div class="col-md-8 col-lg-9">
						<div class="has-validation input-group">
							...
							<input class="form-control <?= form_error('price') === '' ? '' : 'is-invalid' ?>" id="price" inputmode="numeric" name="price" oninput="numberFormat();" placeholder="Masukkan harga produk" type="text" value="<?= html_escape(set_value('price', number_format($product['price'], 0, ',', '.'))) ?>" />
